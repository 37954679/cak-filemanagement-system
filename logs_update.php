			...
			<div class="panel-body">
				<form method="POST" action="update_query.php">
					<div class="form-group">
						<label>file no:</label> 
						<input type="text" class="form-control" value="<?php echo $fetch['file_no']?>" name="file_no" readonly="readonly"/>
						<input type="hidden" value="<?php echo $fetch['file_id']?>" name="file_id"/>
					</div>
					<div class="form-group">
						<label>Filename:</label> 
						<input type="text" class="form-control" value="<?php echo $fetch['filename']?>" name="filename" required="required"/>
					</div>
					<div class="form-group">
